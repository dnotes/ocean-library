---
id: confucius__learning__985846149__en
...
_convertedFrom: 'http://nothingistic.org/library/confucius/learning/'
_softHyphenWords: ''
ocnmd_version: 2
---
## The Text of Confucius {¶="0.0"}
...
*The illustration of illustrious virtue.* {¶="none"}
...
*The renovation of the people.* {¶="none"}
...
*On resting in the highest excellence.* {¶="none"}
...
*Explanation of the root and the branches.* {¶="none"}
...
*On the investigation of things, and carrying knowledge to the utmost extent.* {¶="none"}
...
*On having the thoughts sincere.* {¶="none"}
...
*On personal cultivation as dependent on the rectification of the mind.* {¶="none"}
...
*The necessity of cultivating the person, in order to the regulation of the family.* {¶="none"}
...
*On regulating the family as the means to the well-ordering of the State.* {¶="none"}
...
*On the well-ordering of the State, and making the whole kingdom peaceful and happy.* {¶="none"}
...
In the Book of Ch'û, it is said, "The kingdom of Ch'û does not consider that to be valuable. It values, instead, its good men."
